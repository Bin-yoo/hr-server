    ...
    <div>
        ...
        <Row :style="{margin: '15px 0 0 0'}">
            <Form :model="souformItem">
                ...
                <Col span="2">
                    <FormItem>
                        <DatePicker type="date" placeholder="选择开始日期" v-model="formItem.date"></DatePicker>
                    </FormItem>
                </Col>
                <Col span="1"><p style="line-height: 30px">至</p></Col>
                <Col span="2">
                    <FormItem>
                        <DatePicker type="date" placeholder="选择结束日期" v-model="formItem.date"></DatePicker>
                    </FormItem>
                </Col>
                <Col span="3">
                    <FormItem>
