                ...
                <Col span="21">
                    <Form :model="newUser" :rules="newUserRules" :label-width="80" ref="newUser">
                        ...
                        <FormItem label="用户名" prop="username">
                            <Input v-model="newUser.username" disabled></Input>
                        </FormItem>
                        <FormItem label="用户姓名" prop="name">
                            <Input v-model="newUser.name" placeholder="备注"></Input>
                        </FormItem>
                        <FormItem label="手机号" prop="phone">
                            <Input v-model="newUser.phone" placeholder="请输入用户名"></Input>
                        </FormItem>
                        <FormItem label="联系地址" prop="address">
                            <Input v-model="newUser.address" type="textarea" placeholder="备注"></Input>
                        </FormItem>
            ...
            <Row>
                <Col span="21">
                    <Form :model="user" :rules="newUserRules" :label-width="80" ref="user">
                        ...
                        <FormItem label="手机号" prop="phone">
                            <Input v-model="user.phone" placeholder="请输入用户名"></Input>
                        </FormItem>
                        <FormItem label="联系地址" prop="address">
    ...
    export default{
        ...
        methods: {
            ...
            deleteUser(id){
                this.$Modal.confirm({
                    title: '你正在进行删除操作',
                    content: '<p>删除后相关账号的权限将更改为"普通员工"</p><p>你确定要删除该用户吗?</p>',
                    onOk: () => {
                        var _this = this;
